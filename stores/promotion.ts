    ...
    promotions.value = [
      ...
      },
      {
        ...
        content: `<p><span>🚨 หมายเหตุ 🚨</span></p>
          <p>เพื่อนต้องมียอดฝาก และ ยอดเล่นมากกว่า 250 ต่อคน ค่าแนะนำติดต่อขอรับได้ที่แอดมิน</p>`,
        slug: 'promotion-4',
      },
      {
        ...
        content:
          '<p><span>🚨 หมายเหตุ 🚨</span></p><p><br></p><p>เมื่อแนะนำเพื่อนแล้วรับยอเสียจากเพื่อนทันที 3% ชวนครั้งเดียวได้ตลอดไป</p>',
        slug: 'promotion-5',
      },
      {

<template>
  <footer class="bottom-0 w-full flex flex-col">
    ...
    <section
      class="flex flex-col items-center bg-gradient-to-b from-neutral-950 via-black to-neutral-950 py-8"
    >
    ...
    <section
      class="flex justify-center border-t border-red-900/50 bg-black py-2"
    >
